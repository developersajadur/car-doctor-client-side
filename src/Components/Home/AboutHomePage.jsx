...
const AboutHomePage = () => {
    return (
        <div>
            ...
            <img className=" absolute -right-10 top-1/2 hidden lg:block w-full lg:w-80 mt-10 border-[8px] rounded-xl border-white" src="/public/images/about_us/parts.jpg" alt="" />
                </div>
